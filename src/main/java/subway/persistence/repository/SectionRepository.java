...
public class SectionRepository {
    ...
    public Line findAllSectionByLine(final Line line) {
        ...
        for (SectionEntity sectionEntity : sectionEntities) {
            final Station upStation = stationDao.findById(sectionEntity.getUpStationId()).to();
            final Station downStation = stationDao.findById(sectionEntity.getDownStationId()).to();
